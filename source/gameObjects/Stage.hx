	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			...
			case 'interview':
				...
				curStage = 'stage';
				var bg:FNFSprite = new FNFSprite(-700, -350).loadGraphic(Paths.image('backgrounds/' + curStage + '/interview/bg'));
				bg.antialiasing = true;
				...
				var bg2:FNFSprite = new FNFSprite(-200, -350).loadGraphic(Paths.image('backgrounds/' + curStage + '/interview/gradients'));
				...
				var bg3:FNFSprite = new FNFSprite(-100, 500).loadGraphic(Paths.image('backgrounds/' + curStage + '/interview/gradients'));
				bg3.antialiasing = true;
				bg3.scrollFactor.set(1.0, 1.0);
				bg3.active = true;

				// add to the final array
				add(bg3);
				
				var bg:FNFSprite = new FNFSprite(-160, 40)
				bg4.frames = Paths.getSparrowAtlas('backgrounds/' + curStage + '/interview/starman');
				bg4.animation.addByPrefix('idle', 'starman bop', 24);
				bg4.animation.play('idle');
				bg4.scrollFactor.set(0.8, 0.9);
				add(bg4);
