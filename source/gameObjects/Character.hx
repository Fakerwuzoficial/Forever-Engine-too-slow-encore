	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'dan':
				tex = Paths.getSparrowAtlas('characters/dan');
				frames = tex;
				animation.addByPrefix('idle', 'dan idle', 24, false);
				animation.addByPrefix('singUP', 'dan up', 24);
				animation.addByPrefix('singRIGHT', 'dan right', 24);
				animation.addByPrefix('singDOWN', 'dan down', 24);
				animation.addByPrefix('singLEFT', 'dan left', 24);
				animation.addByPrefix('dialogue1', 'dan dialogue 1', 24);
				animation.addByPrefix('dialogue2', 'dan dialogue 2', 24);
				
				addOffset('idle', -1, -80);
				addOffset("singUP", -1, -67);
				addOffset("singRIGHT", -1, -78);
				addOffset("singLEFT", -1, -84);
				addOffset("singDOWN", -1, -104);
				addOffset("dialogue1", -1, -69);
				addOffset("dialogue2", -1, -72);

				playAnim('idle');
			case 'toby':
				tex = Paths.getSparrowAtlas('characters/toby');
				frames = tex;
				animation.addByPrefix('idle', 'toby idle', 24, false);
				animation.addByPrefix('singUP', 'toby up', 24);
				animation.addByPrefix('singRIGHT', 'toby right', 24);
				animation.addByPrefix('singDOWN', 'toby down', 24);
				animation.addByPrefix('singLEFT', 'toby left', 24);
				animation.addByPrefix('singUP-alt', 'toby uP alt', 24);
				animation.addByPrefix('singRIGHT-alt', 'toby righT alt', 24);
				animation.addByPrefix('singDOWN-alt', 'toby dowN alt', 24);
				animation.addByPrefix('singLEFT-alt', 'toby lefT alt', 24);
				animation.addByPrefix('dialogue1', 'toby dialogue 1', 24);
				animation.addByPrefix('dialogue2', 'toby dialogue 2', 24);
				animation.addByPrefix('cough', 'toby cough', 24);
				animation.addByPrefix('transition', 'toby trans rights', 24);
				
				addOffset('idle', -2, -80);
				addOffset("singUP", -3, -58);
				addOffset("singRIGHT", -9, -90);
				addOffset("singLEFT", 13, -83);
				addOffset("singDOWN", -1, -110);
				addOffset("singUP-alt", -9, -53);
				addOffset("singRIGHT-alt", -19, -88);
				addOffset("singLEFT-alt", 23, -89);
				addOffset("singDOWN-alt", -1, -112);
				addOffset("dialogue1", 4, -62);
				addOffset("dialogue2", 4, -62);
				addOffset("transition", -2, 201);
				addOffset("cough", -112, -110);
				
				playAnim('idle');
			case 'dog':
				tex = Paths.getSparrowAtlas('characters/dog');
				frames = tex;
				animation.addByPrefix('idle', 'dan idle', 24, false);
				animation.addByPrefix('singUP', 'dog up', 24);
				animation.addByPrefix('singRIGHT', 'dog right', 24);
				animation.addByPrefix('singDOWN', 'dog down', 24);
				animation.addByPrefix('singLEFT', 'dog left', 24);
				animation.addByPrefix('dialogue1', 'dog dialogue 1', 24);
				
				addOffset('idle', -1, -80);
				addOffset("singUP", -10, -28);
				addOffset("singRIGHT", -107, -90);
				addOffset("singLEFT", 55, -103);
				addOffset("singDOWN", -39, -130);
				addOffset("dialogue1", 60, -38);
